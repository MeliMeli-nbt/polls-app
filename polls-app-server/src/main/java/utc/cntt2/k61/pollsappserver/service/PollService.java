...
import utc.cntt2.k61.pollsappserver.domain.*;
import utc.cntt2.k61.pollsappserver.dto.PagedResponse;
...
import utc.cntt2.k61.pollsappserver.exception.BadRequestException;
import utc.cntt2.k61.pollsappserver.exception.ResourceNotFoundException;
import utc.cntt2.k61.pollsappserver.mapper.PollMapper;
...
public class PollService {
    ...
    public PollResponse getPollById(Long pollId, UserPrincipal currentUser) {
        ...
        return PollMapper.mapPollToPollResponse(poll, choiceVotesMap,
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        return PollMapper.mapPollToPollResponse(poll, choiceVotesMap, creator, vote.getChoice().getId());
    }
